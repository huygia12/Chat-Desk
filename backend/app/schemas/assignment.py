...
AssignmentRuleValue = list[uuid.UUID] | uuid.UUID | None
...
class AssignmentSettingOut(BaseModel):
    ...
    channel_assignment_rules: dict[str, AssignmentRuleValue] = Field(default_factory=dict)
    label_assignment_rules: dict[str, AssignmentRuleValue] = Field(default_factory=dict)
...
class AssignmentSettingUpdate(BaseModel):
    ...
    channel_assignment_rules: dict[str, AssignmentRuleValue] | None = None
    label_assignment_rules: dict[str, AssignmentRuleValue] | None = None
